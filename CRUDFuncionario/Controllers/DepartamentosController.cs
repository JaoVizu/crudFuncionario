...
namespace CRUDFuncionario.Controllers
{
    public class DepartamentosController : Controller
    {
        ...
        public DepartamentosController(DepartamentoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id_departamento,Nome,Cidade,Fg_ativo")] Departamento departamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id_departamento,Nome,Cidade,Fg_ativo")] Departamento departamento)
        {
