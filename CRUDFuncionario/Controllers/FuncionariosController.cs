...
namespace CRUDFuncionario.Controllers
{
    public class FuncionariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id_funcionario,Id_gerente,Id_departamento,Dt_nascimento,Salario,Cargo,Fg_ativo")] Funcionario funcionario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id_funcionario,Id_gerente,Id_departamento,Dt_nascimento,Salario,Cargo,Fg_ativo")] Funcionario funcionario)
        {
