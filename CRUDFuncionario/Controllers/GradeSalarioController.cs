...
{
    public class GradeSalarioController : Controller
    {
        private readonly GradeSalarioContext _context;

        public GradeSalarioController(GradeSalarioContext context)
        {
            _context = context;
        }
        ...
        // GET: GradeSalario/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: GradeSalario/Create
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create([Bind("Id_salario,Min_salario,Max_salario,Fg_salario")] GradeSalario gradeSalario)
        {
        ...
        // POST: GradeSalario/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id_salario,Min_salario,Max_salario,Fg_salario")] GradeSalario gradeSalario)
        {
